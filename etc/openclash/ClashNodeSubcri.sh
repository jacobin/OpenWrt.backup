...
if [ "$file_hash" != "aa8d53ded08777369712db2df760d089d03ce24289ea7f20b22c0c00ce4239ee" ]; then
...
if [[ 0 < ${speedSize} ]]; then
    tee_echo "\tThe network is still available. Exit this time."
    singleton_clean_up 1
fi
